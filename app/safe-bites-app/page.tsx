  ...
  return (
    <main className=" flex justify-center">
      ...
      <div className=" flex items-center justify-center flex-col lg:max-w-[50rem] md:max-w-[40rem] sm:max-w-[35rem] xs:max-w-[10rem] px-5">
        <SectionHeading>Safe Bites Mobile App</SectionHeading>
        ...
        <div className="flex flex-col md:flex-row justify-center mt-5">
          <div className="md:mr-4">
            ...
            <Image
              src={SB1}
              alt="Screen shot of a light green background and a demo iphone screen showing the old app design"
              width="500"
              quality="95"
          ...
          <div className="md:ml-4">
            ...
            <Image
              src={SB2}
              alt="Screen shot of a light blue background and a demo iphone screen showing the new app design"
              width="500"
              quality="95"
              className="h-50 w-50 rounded border object-cover shadow-xl my-5"
            />
        ...
        <div>
          ...
          <p className="mb-3"><span className="font-medium">Constraints:</span>Time -- Finishing app while the need still exists</p>
        </div>
        ...
        <p>The UX of the project was created under the constraints of the hackathon deadline and was not optimized with feedback due to a lack of time (also needed to build and create a pitch for the app).</p>

        <div className="flex justify-center">
          <Image
            src={UX1}
            alt="Example UX of the old app design. Shows eight screens ranging from home screen to portfolio page."
            width="700"
            quality="100"
            className="h-50 w-50 rounded border object-cover shadow-xl my-5"
          />
        ...
        <p>After the hackathon, the team pursued the app development. I became the project manager that helped with product development and design. Most members of our 12 person team focused on outreach and design feedback. I was one of two coders and designers for the project. I also taught workshops for the other team members on React Native mobile app programming and how to use Figma.</p>
        ...
        <G2ImageCard
          ...
          descL="1. Researched designs of other restaurants related applications to understand what users were used to/expected. Image sourced from Lucia Liu's medium article."
          srcR={UX2}
          ...
          descR="2. Testing new homepage screens to include more functionality than the previous design. The design above was created as a team as we talked through the app's most important elements."
        />
        ...
        <G2ImageCard
          ...
          descL="3. Met with the chief of staff at Yelp to understand the challenges of launching products in the restaurant industry. We also got feedback on our UX and business strategy. "
          srcR={team}
